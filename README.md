...
Reference:
Research Paper: [Template-based Reconstruction of Complex Refactorings, Kyle Prete, Napol Rachatasumrit, Nikita Sudan, and Miryung Kim, ICSM '10: Proceedings of the 26th IEEE International Conference on Software Maintenance, Pages 1-10.](http://web.cs.ucla.edu/~miryung/Publications/icsm10-reffinder.pdf)
...
We no longer maintain Ref-Finder, unfortunately we don't have available source code now. Here is an example on how to use Ref-Finder jar file to identify refactorings. 
