...
/* 148 */     final PreparedQuery runable = e.prepareForRunning(this);
/*     */     
/*     */ 
/*     */ 
...
/* 166 */       ElementSource result = new DelayedElementSource()
/*     */       {
/*     */         protected ElementSource produce()
/*     */         {
/* 170 */           return runable.start();
/*     */         }
/*     */         
...
/*     */     throws TypeModeError, ParseException
/*     */   {
/* 197 */     frameQuery(e).map(new Action() {
/*     */       public Object compute(Object f) {
/* 199 */         return ((Frame)f).get(v);
/*     */       }
/*     */     });
/*     */   }
/*     */   
...
/* Location:              /Users/UCLAPLSE/Downloads/LSclipse_1.0.4.jar!/tyRuBa/engine/QueryEngine.class
