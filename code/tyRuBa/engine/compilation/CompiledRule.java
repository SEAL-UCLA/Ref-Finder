...
/*    */     
/*    */ 
/* 41 */     final Frame callFrame = new Frame();
/*    */     
...
/* 53 */     this.compiledCond.runNonDet(fc, context).map(new tyRuBa.util.Action() {
/*    */       public Object compute(Object resultFrame) {
/* 55 */         Frame result = callFrame.callResult((Frame)resultFrame);
/*    */         
/* 57 */         return result;
/*    */       }
/*    */       
/* 60 */       public String toString() { return "callFrame" + callFrame; }
/*    */     });
/*    */   }
/*    */   
/*    */ 
...
/* Location:              /Users/UCLAPLSE/Downloads/LSclipse_1.0.4.jar!/tyRuBa/engine/compilation/CompiledRule.class
