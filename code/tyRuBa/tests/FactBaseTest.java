...
/*     */   }
/*     */   
/*     */   private class RandomQueriesThread extends FactBaseTest.TesterThread
/*     */   {
/*     */     int howmany;
/*     */     
...
/*     */     {
/*  42 */       super(name, null);
/*  43 */       this.howmany = howmany;
/*     */     }
/*     */     
/*     */     public void run() {
/*     */       try {
/*  48 */         FactBaseTest.this.doRandomQueries(this.howmany);
/*     */       } catch (Throwable e) {
/*  50 */         this.crash = e;
/*  51 */         e.printStackTrace();
/*  52 */         if (Aurelizer.debug_sounds != null) {
/*  53 */           Aurelizer.debug_sounds.enter("error");
/*     */         }
/*     */       }
/*     */     }
/*     */   }
/*     */   
/*     */   private class OutdatingThread extends FactBaseTest.TesterThread
/*     */   {
/*     */     int howmany;
/*     */     
/*     */     OutdatingThread(String name, int howmany) {
/*  64 */       super(name, null);
/*  65 */       this.howmany = howmany;
/*     */     }
/*     */     
/*     */     public void run() {
/*     */       try {
/*  70 */         for (int i = 0; i < this.howmany; i++) {
/*  71 */           FactBaseTest.this.doRandomQueries(1);
/*  72 */           FactBaseTest.this.outdateSomebuckets(i, i + 1);
/*     */         }
/*     */       } catch (Throwable e) {
/*  75 */         this.crash = e;
/*  76 */         throw new Error("Thread " + getName() + " crashed: " + e);
/*     */       }
/*     */     }
/*     */   }
/*     */   
/*     */   private class KillingThread extends FactBaseTest.TesterThread
/*     */   {
/*     */     int howmany;
/*     */     
...
/*     */     public void run() {
/*     */       try {
/*  92 */         while (FactBaseTest.this.test_atoms.length > 1) {
/*  93 */           FactBaseTest.this.doRandomQueries(1);
/*  94 */           FactBaseTest.this.shrinkAtoms();
/*     */         }
/*     */       } catch (Throwable e) {
/*  97 */         this.crash = e;
/*  98 */         e.printStackTrace();
/*  99 */         throw new Error("Thread " + getName() + " crashed: " + e);
/*     */       }
/*     */     }
/*     */   }
/*     */   
/*     */   private class DoRandomThingsThread extends FactBaseTest.TesterThread
/*     */   {
/*     */     int howmany;
/*     */     String name;
/*     */     
...
/*     */       try
/*     */       {
/* 120 */         for (int i = 0; i < this.howmany; i++) {
/* 121 */           switch (rnd.nextInt(10)) {
/*     */           case 0: 
/* 123 */             System.err.println(this.name + " " + i + " BEG backup");
/* 124 */             FactBaseTest.this.frontend.backupFactBase();
/* 125 */             System.err.println(this.name + " " + i + " END backup");
/* 126 */             break;
/*     */           case 1: 
/* 128 */             System.err.println(this.name + " " + i + " BEG outdating");
/* 129 */             FactBaseTest.this.outdateSomebuckets(rnd.nextInt(2), rnd.nextInt(4) + 1);
/* 130 */             System.err.println(this.name + " " + i + " END outdating");
/* 131 */             break;
/*     */           default: 
/* 133 */             System.err.println(this.name + " " + i + " BEG query");
/* 134 */             FactBaseTest.this.doRandomQueries(1);
/* 135 */             System.err.println(this.name + " " + i + " END query");
/*     */           }
/*     */         }
/*     */       }
/*     */       catch (BackupFailedException e)
/*     */       {
/* 141 */         System.err.print("Backup fact base failed, but this is normal behavior");
/* 142 */         e.printStackTrace();
/*     */       }
/*     */       catch (Throwable e) {
/* 145 */         this.crash = e;
/* 146 */         e.printStackTrace();
/* 147 */         throw new Error("Thread " + getName() + " crashed: " + e);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/* 238 */       this.buckets[i] = new RubFileBucket(this.frontend, this.bucket_fle[i]);
/*     */     }
/*     */   }
/*     */   
...
/*     */     
/* 368 */     TesterThread[] thread = new TesterThread[10];
/* 369 */     for (int i = 0; i < thread.length; i++) {
/* 370 */       thread[i] = new DoRandomThingsThread(i, 40);
/* 371 */       thread[i].start();
...
/*     */     
/*     */ 
/* 392 */     TesterThread[] thread = new TesterThread[20];
/* 393 */     for (int i = 0; i < thread.length - 1; i++) {
/* 394 */       thread[i] = new RandomQueriesThread(i, 20);
/* 395 */       thread[i].start();
/* 396 */       System.out.println("Thread " + i + " started");
/*     */     }
/*     */     
/* 399 */     thread[(thread.length - 1)] = new KillingThread("killing");
...
/*     */     
/* 702 */     RandomQueriesThread[] thread = new RandomQueriesThread[10];
/* 703 */     for (int i = 0; i < thread.length; i++) {
/* 704 */       thread[i] = new RandomQueriesThread(i, 10);
/* 705 */       thread[i].start();
...
/*     */     
/*     */ 
/* 723 */     TesterThread[] thread = new TesterThread[11];
/* 724 */     for (int i = 0; i < thread.length - 1; i++) {
/* 725 */       thread[i] = new RandomQueriesThread(i, 20);
/* 726 */       thread[i].start();
/* 727 */       System.out.println("Thread " + i + " started");
/*     */     }
/*     */     
/* 730 */     thread[(thread.length - 1)] = new OutdatingThread("outdating", 20);
...
/* 781 */       super(filename);
/* 782 */       this.myfile = filename;
/*     */     }
/*     */     
/*     */     public void update() throws ParseException, TypeModeError
/*     */     {
/*     */       try {
/* 788 */         load(this.myfile);
/* 789 */         FactBaseTest.this.bucketLoads += 1;
/*     */       }
/*     */       catch (IOException e) {
/* 792 */         throw new Error("IOError for file " + this.myfile + ": " + e.getMessage());
/*     */       }
/*     */     }
/*     */     
/*     */     public String toString() {
/* 797 */       return "RubFileBucket(" + this.myfile + ")";
/*     */     }
/*     */   }
/*     */ }


/* Location:              /Users/UCLAPLSE/Downloads/LSclipse_1.0.4.jar!/tyRuBa/tests/FactBaseTest.class
