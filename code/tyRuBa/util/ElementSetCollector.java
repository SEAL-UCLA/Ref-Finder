...
/* 68 */       testSet.elements().map(new Action() {
/*    */         public Object compute(Object a) {
/* 70 */           int i = ((Integer)a).intValue();
/* 71 */           i = (i + 1) % 10;
/* 72 */           return new Integer(i);
/*    */         }
/*    */         
/*    */ 
/* 76 */       }).append(ElementSource.singleton(new Integer(1))));
/*    */     
...
/* Location:              /Users/UCLAPLSE/Downloads/LSclipse_1.0.4.jar!/tyRuBa/util/ElementSetCollector.class
