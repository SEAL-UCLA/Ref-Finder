...
/*  44 */       return ++this.data & 0xFFFF;
/*     */     }
/*     */     
/*     */     public final int preDecrementCount() {
/*  48 */       return --this.data & 0xFFFF;
/*     */     }
/*     */     
/*     */     public final void setFlags(int flags) {
/*  52 */       this.data = ((this.data & 0xFFFF) + (flags << 16));
/*     */     }
/*     */     
/*     */     public final int getFlags() {
/*  56 */       return this.data >> 16;
/*     */     }
/*     */     
/*     */     public String toString() {
/*  60 */       return String.valueOf(this.key) + "=" + this.value;
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/*  82 */     if (obtained == 32) {
/*  83 */       Entry[] ntable = grow ? new Entry[this.table.length * 2] : new Entry[this.table.length / 2];
/*  84 */       int location = 0;
/*     */       
/*     */ 
/*     */ 
...
/*  90 */         Entry bucket = this.table[location];
/*     */         
/*  92 */         while (bucket != null) {
/*  93 */           Entry next = bucket.next;
/*     */           
...
/*     */ 
/*     */ 
/* 127 */     this.table = new Entry[initialSize];
/* 128 */     this.size = 0;
...
/* 151 */         Entry bucket = this.table[location];
...
/* 177 */         Entry bucket = this.table[location];
...
/*     */       {
/*     */ 
/* 207 */         Entry bucket = this.table[location];
/*     */         
...
/*     */         }
/*     */         
/* 219 */         this.table[location] = new Entry(key, value, this.table[location]);
/*     */         
...
/* 241 */         Entry previous = null;
/* 242 */         Entry bucket = this.table[location];
/*     */         
...
/* 278 */         Entry bucket = this.table[location];
/*     */         
...
/* 301 */         Entry bucket = this.table[location];
/*     */         
...
/* Location:              /Users/UCLAPLSE/Downloads/LSclipse_1.0.4.jar!/tyRuBa/util/CountedHashMap.class
