  ...
  implements TyRuBaParserConstants
{
  ...
  private final boolean jj_2_1(int xla)
  {
    ...
    catch (TyRuBaParser.LookaheadSuccess ls)
    {
      return true;
    }
    finally
  ...
  private final TyRuBaParser.JJCalls[] jj_2_rtns = new TyRuBaParser.JJCalls[6];
  ...
  public TyRuBaParser(InputStream stream)
  {
    ...
    for (int i = 0; i < this.jj_2_rtns.length; i++) {
      this.jj_2_rtns[i] = new TyRuBaParser.JJCalls();
    }
  }
    ...
    throws ParseException
  {
    ...
    if (this.token.kind == kind)
    {
      ...
      if (++this.jj_gc > 100)
      {
        ...
        for (int i = 0; i < this.jj_2_rtns.length; i++)
        {
          TyRuBaParser.JJCalls c = this.jj_2_rtns[i];
          while (c != null)
          {
  ...
  private final TyRuBaParser.LookaheadSuccess jj_ls = new TyRuBaParser.LookaheadSuccess(null);
  ...
  private final void jj_rescan_token()
  {
    ...
    for (int i = 0; i < 6; i++)
    {
      TyRuBaParser.JJCalls p = this.jj_2_rtns[i];
      do
      {
  ...
  {
    TyRuBaParser.JJCalls p = this.jj_2_rtns[index];
    while (p.gen > this.jj_gen)
    {
      if (p.next == null)
      {
        p = p.next = new TyRuBaParser.JJCalls(); break;
      }
      p = p.next;
    }
