...
/*  178 */     } catch (IOException e) { return pos + 1; }
...
/* 1568 */         return curPos;
/* 1569 */       try { this.curChar = this.input_stream.readChar(); } catch (IOException e) {} }
/* 1570 */     return curPos;
/*      */   }
/*      */   
/*      */ 
...
/* 1590 */     } catch (IOException e) { return pos + 1; }
...
/* 1673 */         return curPos;
/* 1674 */       try { this.curChar = this.input_stream.readChar(); } catch (IOException e) {} }
/* 1675 */     return curPos;
/*      */   }
/*      */   
/*      */ 
...
/* 1695 */     } catch (IOException e) { return pos + 1; }
...
/* 1778 */         return curPos;
/* 1779 */       try { this.curChar = this.input_stream.readChar(); } catch (IOException e) {} }
/* 1780 */     return curPos;
/*      */   }
/*      */   
...
/* Location:              /Users/UCLAPLSE/Downloads/LSclipse_1.0.4.jar!/bin/tyRuBa/parser/TyRuBaParserTokenManager.class
