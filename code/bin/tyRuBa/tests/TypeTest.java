  ...
  implements Serializable
{
    ...
    throws ParseException, TypeModeError, TyrubaException
  {
    ...
    this.frontend.addTypeMapping(new FunctorIdentifier("SourceLocation", 0), new TypeTest.1(this));
    
    this.frontend.parse("label(SourceLocation<?,?,?,?>,tisASourceLocation).");
    this.frontend.parse("label(SourceLocation<foo,1,2,3>,niceOne).");
    
    TypeTest.SourceLocation sl1 = new TypeTest.SourceLocation("foo", 1, 2, 3);
    TypeTest.SourceLocation sl2 = new TypeTest.SourceLocation("bar", 2, 3, 4);
    ...
    throws Exception
  {
    ...
    TypeTest.SourceLocation sl = new TypeTest.SourceLocation("foo", 1, 2, 3);
