...
public class ModedRuleBaseCollection
{
  ...
  private RuleBase newModedRuleBase(PredicateMode pm, FactBase facts)
  {
    ...
    {
      ModedRuleBaseCollection.InsertionInfo insertion = (ModedRuleBaseCollection.InsertionInfo)iter.next();
    ...
    throws TypeModeError
  {
    ...
    {
      this.unconvertedRules.add(new ModedRuleBaseCollection.InsertionInfo(this, r, rulebases, resultTypes));
