...
/* 30 */     SemiDetCachedRuleBase.CacheEntry entry = (SemiDetCachedRuleBase.CacheEntry)this.cache.get(k);
/*    */     Frame cachedResult;
/* 32 */     if ((entry == null) || 
...
/* 41 */       entry = new SemiDetCachedRuleBase.CacheEntry(this, k, result);
...
/* Location:              /Users/UCLAPLSE/Downloads/LSclipse_1.0.4.jar!/bin/tyRuBa/engine/SemiDetCachedRuleBase.class
