  ...
  implements Iterator<ArrayList<String>>
{
  ...
  private ArrayList<FactClassifier.ClusterInfo> clusters = new ArrayList();
  private Iterator<FactClassifier.ClusterInfo> clusterIterator;
  private FactClassifier.ClusterInfo currentCluster = null;
    ...
    throws ParseException, TypeModeError, IOException
  {
    ...
    for (LSDRule rule : this.typeLevelRules)
    {
      ...
      FactClassifier.ClusterInfo info = new FactClassifier.ClusterInfo(this, null);
      info.rule = rule;
  ...
  {
    this.currentCluster = ((FactClassifier.ClusterInfo)this.clusterIterator.next());
