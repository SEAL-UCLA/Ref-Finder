...
/*    */   {
/* 24 */     this.name_ = "change_uni_to_bi";
/*    */   }
/*    */   
...
/* 45 */     return "before_field(?fFullName, ?, ?t2FullName),after_field(?fFullName, ?, ?t2FullName),before_fieldoftype(?fFullName, ?tpFullName),after_fieldoftype(?fFullName, ?tpFullName),added_field(?f2FullName, ?, ?tFullName),added_fieldoftype(?f2FullName, ?t2pFullName),NOT(equals(?tFullName, ?t2FullName))";
/*    */   }
/*    */   
/*    */ 
/*    */ 
...
/* Location:              /Users/UCLAPLSE/Downloads/LSclipse_1.0.4.jar!/bin/lsclipse/rules/ChangeUnidirectionalAssociationToBi.class
