...
/*    */   {
/* 26 */     this.name_ = "introduce_explaining_variable";
/*    */   }
/*    */   
...
/* 46 */     return "added_localvar(?mFullName,?,?identifier,?expression),NOT(deleted_localvar(?mFullName,?,?identifier,?)),NOT(deleted_localvar(?mFullName,?,?,?expression)),deleted_methodbody(?mFullName,?mBody),added_methodbody(?mFullName,?newmBody)";
/*    */   }
/*    */   
/*    */ 
/*    */ 
...
/* Location:              /Users/UCLAPLSE/Downloads/LSclipse_1.0.4.jar!/bin/lsclipse/rules/IntroduceExplainingVariable.class
