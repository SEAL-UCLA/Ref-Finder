...
class ReplaceNestedCondWithGuardClausesExporter extends RefactoringCsvExporter {

	ReplaceNestedCondWithGuardClausesExporter() {
		
	}
	
	@Override
	protected String fileName() {
		return "REPLACE_NESTED_COND_WITH_GUARD_CLAUSES.csv";
	}
