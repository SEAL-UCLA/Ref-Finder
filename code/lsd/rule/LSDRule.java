...
/*     */   public LSDRule() {}
/*     */   
/*     */   public class LSDRuleComparator implements Comparator<LSDRule> { public LSDRuleComparator() {}
/*     */     
/*  41 */     public int compare(LSDRule r1, LSDRule r2) { return 
/*  42 */         r2.score - r1.score == 0.0D ? 0 : r2.score - r1.score > 0.0D ? 1 : -1;
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/*     */       
/* 439 */       System.out.println(lsd.io.LSDAlchemyRuleReader.parseAlchemyRule("before_typeintype(z, x) ^ before_typeintype(x, z) => added_type(x)").canonicalRepresentation());
/*     */       
...
/* Location:              /Users/UCLAPLSE/Downloads/LSclipse_1.0.4.jar!/lsd/rule/LSDRule.class
